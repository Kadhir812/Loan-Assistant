...
async def start_request(customer_id: str, query: str):

    config = create_config(customer_id)
...
async def resume_request(config: dict, human_data: dict):
...
async def main():
    ...
    try:
        ...
        result, config = await start_request(
            customer_id,
            query
        )
